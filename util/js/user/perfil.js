                    ...
                    success: function data(datos) {
                        ...
                        $.each(arrayDatos, function(val) {
                                for (var i = 0; i < arrayDatos[val].length; i++) {
                                    ...
                                    stringAppend += "<button class = 'btn-link left btnComentario' type='button' data-toggle='modal' data-target= '#myModal' id = '"+arrayDatos.deseo[i].id_publicacion+"'> Comentarios </button>";
                                    stringAppend += "<button class='btn btn-link pull-right editar' ><a href='borrarDeseo/?code='"+arrayDatos.deseo[i].id_publicacion+"'><span class='glyphicon glyphicon-trash pull-right' aria-hidden='true'></span></a></button>";
