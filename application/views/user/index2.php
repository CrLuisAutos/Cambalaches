...
<html lang="en">
  ...
  ventana . fbAsyncInit = función () { 
    FB . init ({ 
      Id de aplicación       : "123917718144834" , 
      XFBML       : cierto , 
      la versión     : 'v2.8' }); 
  ...
  ( Función ( d , s , ID ) { var js , FJS = d . GetElementsByTagName ( s ) [ 0 ]; si ( d . GetElemenById ( ID )) { retorno ;} 
     js = d . CreateElement ( s ); js . Identificación = Identificación ; 
